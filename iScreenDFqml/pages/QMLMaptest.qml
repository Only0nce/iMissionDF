...
Item {
    ...
    property int  maxDoaDelayMs: 2000          // ✅ หน่วง 2 วิ ก่อนส่ง
    ...
    Item {
        ...
        function rebuildHudList() {
            ...
            // ✅ if you ever want selected on top, set selectedFirst=true
        ...
        Connections {
            ...
            function onSelectedKeyChanged() {
                // ✅ keep pinned highlight in sync if you want (optional)
                // if (hudBox.pinnedKey === "") hudBox.pinnedKey = mapviewer.selectedKey
        ...
        ListView {
            ...
            delegate: Item {
                ...
                property bool  isHi: (cardKey === mapviewer.selectedKey) || hudBox._isPinnedOrHovered(cardKey)
                ...
                Rectangle {
                    ...
                    opacity: 0.72
                    border.width: 2
                    border.color: card.isHi ? card.pinColor : "#2A3A44"
                }
                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        color: card.isHi ? card.pinColor : "#9aa6b2"
                        opacity: 0.9
                ...
                MouseArea {
                    ...
                    onClicked: {
                        ...
                        // ❗ถ้าไม่อยากให้ map กระโดด/เปลี่ยนตำแหน่ง ให้คอมเมนต์ 2 บรรทัดนี้
                        ...
                        Column {
                            ...
                            Text {
                                text: (card.doaIt)
                                      ...
                                      : "DoA: -"
                                color: String(card.pinColor || "#1DCD9F")
                                font.pixelSize: 14
                                font.bold: true
                                elide: Text.ElideRight
                                width: parent.width
